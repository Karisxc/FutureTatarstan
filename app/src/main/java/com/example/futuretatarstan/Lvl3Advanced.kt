...
class Lvl3Advanced : AppCompatActivity() {
    private lateinit var sharedPreferencesManager: SharedPreferencesManager
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_lvl3_advanced)
    ...
    private fun checkAnswers() {
        ...
        val isAnswer1Correct = radioButton1.text == "Стратегия"
        val isAnswer2Correct = radioButton2.text == "Развитие"
        ...
        if (isAnswer1Correct && isAnswer2Correct) {
            ...
            if (currentUser != null) {
                dbHelper.addPoints(currentUser.login, 150)

            }
            if (currentUser != null){
                dbHelper.addReit(currentUser.login,4)
            }
